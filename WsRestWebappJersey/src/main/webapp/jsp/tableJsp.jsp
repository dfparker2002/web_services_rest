...
<head>
	...
	<script type="text/javascript">
		...
		function loadTable(){
			...
			var requestUrlJson = "rest/ajax/table";
...
<div style="width: 400px; font-family: Arial; font-size: 9pt;">
	<table>
					...
					<tbody>	
						...
						<script id="usersTableTemplate" type="text/x-jquery-tmpl">		
							<tr>					 
								...
								<td>\${name}</td>
								<td> 
									<a href="rest/table/view-link/\${id}">View</a> &nbsp;
									<a href="rest/table/edit-link/\${id}">Edit</a> &nbsp;
									<a href="rest/table/delete-link/\${id}">Delete</a> 
								</td>
							</tr>	
						</script>
		...
		<tr>
			<td colspan="2">
				<a id="create" name="create" href="rest/table/create-button">Create</a>
			</td>
		</tr>		
	</table>
</div>
